...
Settings::loadSettings()
{
    ...
    settings.beepBeforeFreq = qsettings.value("beepBeforeFreq", 660.0).toDouble();
    settings.beepBeforeDuration = qsettings.value("beepBeforeDuration", 80).toInt();
    settings.beepBeforeAmplitude = qsettings.value("beepBeforeAmplitude", 0.4).toDouble();
    settings.beepAfterDoubleFreq1 = qsettings.value("beepAfterDoubleFreq1", 880.0).toDouble();
    settings.beepAfterDoubleDur1 = qsettings.value("beepAfterDoubleDur1", 60).toInt();
    settings.beepAfterDoubleFreq2 = qsettings.value("beepAfterDoubleFreq2", 660.0).toDouble();
    settings.beepAfterDoubleDur2 = qsettings.value("beepAfterDoubleDur2", 120).toInt();
    settings.beepAfterDoubleAmplitude = qsettings.value("beepAfterDoubleAmplitude", 0.5).toDouble();
...
void Settings::saveSettings(const AppSettings& settings)
{
    ...
    qsettings.setValue("beepBeforeFreq", settings.beepBeforeFreq);
    qsettings.setValue("beepBeforeDuration", settings.beepBeforeDuration);
    qsettings.setValue("beepBeforeAmplitude", settings.beepBeforeAmplitude);
    qsettings.setValue("beepAfterDoubleFreq1", settings.beepAfterDoubleFreq1);
    qsettings.setValue("beepAfterDoubleDur1", settings.beepAfterDoubleDur1);
    qsettings.setValue("beepAfterDoubleFreq2", settings.beepAfterDoubleFreq2);
    qsettings.setValue("beepAfterDoubleDur2", settings.beepAfterDoubleDur2);
    qsettings.setValue("beepAfterDoubleAmplitude", settings.beepAfterDoubleAmplitude);
